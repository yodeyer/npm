...
var asyncLimiter = require('../utils/async-limiter.js')
var asyncUnique = require('../utils/async-unique.js')
...
function andForEachChild (load, next) {
  ...
  return function (er, children, logs) {
    ...
    asyncMap(sortedCmds, function (params, done) {
      var fn = params.shift()
      params.push(done)
...
var addDependency = asyncUnique(asyncLimiter(require('../utils/async-log')(function (name, versionSpec, tree, log, done) {
